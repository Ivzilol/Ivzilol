...
<p dir="auto"><a href="https://skillicons.dev" rel="nofollow"><img src="https://skillicons.dev/icons?i=java,spring,js,react,html,css,vscode,idea,mysql,regex,docker,kafka,terraform,prometheus,grafana,mongodb" alt="My Skills" data-canonical-src="https://skillicons.dev/icons?i=java,spring,js,react,html,css,vscode,idea,visualstudio,mysql,regex,docker,kafka,terraform,prometheus,grafana,mongodb" style="max-width: 100%;"></a></p>
<!-- <th/> -->
